...
<div class="bg-[#141326] border-r border-border-color py-4 overflow-y-auto">
    <div class="relative mx-4 my-2">
        ...
        <!-- Dropdown Menu -->
        <div id="newDropdown"
            class="absolute top-full left-0 right-0 mt-2 bg-[#2B2C61] border border-border-color rounded-lg shadow-xl z-50 overflow-hidden opacity-0 invisible transform translate-y-[-10px] transition-all duration-200">
            <div class="py-2">
...
<main class="bg-[#141326] p-6 overflow-y-auto">
    ...
    <div id="new-button-container" class="flex items-center mb-6 gap-4 flex-wrap">
        <button
            class="bg-[#3C3F58] py-2 px-4 border border-border-color rounded-3xl text-sm text-primary border-[#c6dafc]">All
            Documents</button>
        <button
            class="bg-[#3C3F58] py-2 px-4 border border-border-color rounded-3xl text-sm text-white text-text-secondary hover:bg-bg-light">PDF
            Files</button>
        <button
            class="bg-[#3C3F58] py-2 px-4 border border-border-color rounded-3xl text-sm text-white text-text-secondary hover:bg-bg-light">Word
            Documents</button>
        <button
            class="bg-[#3C3F58] py-2 px-4 border border-border-color rounded-3xl text-sm text-white text-text-secondary hover:bg-bg-light">Images</button>
        <button
            class="bg-[#3C3F58] py-2 px-4 border border-border-color rounded-3xl text-sm text-white text-text-secondary hover:bg-bg-light">Spreadsheets</button>
