...
function createFileElement(file) {
    ...
    fileElement.innerHTML = `
        ...
        <div class="p-3 relative">
            <div class="text-sm text-white whitespace-nowrap overflow-hidden text-ellipsis mb-1">${file.file_name}</div>
            <div class="text-xs text-white text-text-secondary">Modified: ${fileDate}</div>
