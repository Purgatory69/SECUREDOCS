...
function handleFiles(files) {
  ...
  for (var i = 0; i < files.length; i++) {
    ...
    fileItem.innerHTML = "\n            <div class=\"flex items-center\">\n                <span class=\"mr-2\">".concat(getFileIcon(file.name), "</span>\n                <span class=\"truncate max-w-[200px]\">").concat(file.name, "</span>\n            </div>\n            <span class=\"text-text-secondary text-xs\">").concat(fileSize, " MB</span>\n        ");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.addEventListener('click', function (event) {
    ...
    var isClickInside = userProfileBtn.contains(event.target) || profileDropdown.contains(event.target);
  ...
  // Upload button logic
  if (uploadBtn) {
    uploadBtn.addEventListener('click', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var files, file, userId, _yield$supabase$stora, data, error, response;
        ...
        while (1) switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            return supabase.storage.from('files').upload("user_".concat(userId, "/").concat(file.name), file, {
              ...
              onProgress: function onProgress(event) {
                ...
                if (progressPercentage) progressPercentage.textContent = "".concat(Math.round(percent), "%");
              }
            });
          case 11:
          ...
          case 19:
            ...
            return fetch('/files', {
              ...
              body: JSON.stringify({
                file_name: file.name,
                file_path: "user_".concat(userId, "/").concat(file.name),
                file_size: file.size,
                file_type: file.type,
                mime_type: file.type
              })
...
function _loadUserFiles() {
  _loadUserFiles = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var response, data, filesContainer, files;
      ...
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 18:
          files.forEach(function (file) {
            ...
            var fileDate = new Date(file.created_at).toLocaleDateString('en-US', {
              year: 'numeric',
              month: 'short',
              day: 'numeric'
            });
            var fileType = file.file_type ? file.file_type.toUpperCase() : '';
            var badgeHtml = '';
            if (["pdf", "docx", "xlsx", "pptx"].includes((_file$file_type = file.file_type) === null || _file$file_type === void 0 ? void 0 : _file$file_type.toLowerCase())) {
              badgeHtml = "<div class=\"absolute top-2 right-2 bg-[#e8f0fe] text-primary px-1.5 py-0.5 rounded text-xs font-medium\">".concat(fileType, "</div>");
            }
            fileElement.innerHTML = "\n                <div class=\"h-[120px] bg-bg-light flex items-center justify-center border-b border-border-color relative\">\n                    <span class=\"text-3xl\">".concat(fileIcon, "</span>\n                    ").concat(badgeHtml, "\n                </div>\n                <div class=\"p-3 relative\">\n                    <div class=\"text-sm whitespace-nowrap overflow-hidden text-ellipsis mb-1\">").concat(file.file_name, "</div>\n                    <div class=\"text-xs text-text-secondary\">Modified: ").concat(fileDate, "</div>\n                    <button class=\"delete-file-btn absolute top-3 right-3 text-text-secondary hover:text-danger\" data-file-id=\"").concat(file.id, "\">\n                        <svg xmlns=\"http://www.w3.org/2000/svg\" class=\"h-5 w-5\" fill=\"none\" viewBox=\"0 0 24 24\" stroke=\"currentColor\">\n                            <path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16\" />\n                        </svg>\n                    </button>\n                </div>\n            ");
        ...
        case 23:
          ...
          console.error('Error loading files:', _context3.t0);
        case 26:
        case "end":
...
/******/ 			if (chunkId === "node_modules_ws_browser_js") return "js/" + chunkId + ".js";
